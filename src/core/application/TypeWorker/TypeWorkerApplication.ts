import { AllTypeWorkerDto, NewTypeWorkerDto, OneTypeWorkerDto, UpdateTypeWorkerDto } from "src/core/shared/dto/TypeWorker/type_worker_dto";
...
export interface TypeWorkerApplication {
  ...
  updateTypeWorker(code: string, type_worker: UpdateTypeWorkerDto): Promise<OneTypeWorkerDto>
